...
rolle_spalten = ['Verfasser', 'Herausgeber', 'Übersetzer', 'keineRolle', 'sonstigeRolle']
...
personen_df.to_csv(
    r'Pfadzu\Person.csv', # Pfad anpassen
