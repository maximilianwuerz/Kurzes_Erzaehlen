...
wettbewerb_df = pd.read_csv(
    r'Pfadzu\Konsolidierte\Literaturwettbewerb_Ausgabe_kk_pk.csv', # Pfad anpassen
    sep=';', encoding='utf-8'
)

# 4. Schritt: Einlesen der konsolidierten Literaturzeitschrift_Ausgabe-CSV
literaturzeitschrift_df = pd.read_csv(
    r'Pfadzu\Konsolidierte\Literaturzeitschrift_Ausgabe_kk_pk.csv', # Pfad anpassen
    sep=';', encoding='utf-8'
)
...
personen_df.to_csv(
    r'Pfadzu\Konsolidierte\Person_kk_pk.csv', # Pfad anpassen
