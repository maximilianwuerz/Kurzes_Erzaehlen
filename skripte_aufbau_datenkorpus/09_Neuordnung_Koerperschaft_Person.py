...
# Anpassung 30.06.2025: Vermeidung von Duplikaten in Personendaten wurde angepasst, damit leere Einträge in person_name
# nicht weiter berücksichtigt werden. Somit bleiben FF-Autoren ohne Eintrag bei Vor-/Nachname erhalten (ab Zeile 722)
...
"Scholz, Doris Maria",
"Mock-Kamm, Doris",
"Innerhofer, Agnes; Loinichler, Hubert",
"Oberle, Jürgen",
"Rüdinger, Elisabeth",
"Bockamp, Elke",
"Hörzer, Erika",
...
"Güntzel, Joachim",
"Munique, Johannes",
"Contreras, Jose Carlos",
"Weese, Jörg",
"Pröll, Juliane",
"Braunersreuther, Jutta Ch.",
"Berus, Jürgen",
"Hanik, Jürgen",
"Reichardt-Kron, Jürgen",
"Ruszkowski, Jürgen",
"Müller, Karl",
"Pilcz, Karlheinz",
...
"Karl-May-Verlag", 
'"Das Geheimnis des Überseekoffers", Autorengruppe"', 
"Wortspieler", 
"wirschreibenfürahrweiler, Autorengemeinschaft",
"Abraxas &lt", 
"adakia Verlag", 
"Aids-Hilfe NRW e.V. / Landesarbeitsgemeinschaft Frauen und Aids in NRW", 
...
# Dateipfade
person_file = r'Pfadzu\Konsolidierte\Person_kk_pk.csv' # Pfad anpassen
koerperschaft_file = r'Pfadzu\Konsolidierte\Koerperschaft_kk_pk.csv' # Pfad anpassen
...
# Vermeidung von Duplikaten in Personendaten, speziell auf person_username achten
person_df = pd.concat([person_df, personen_zu_verschieben], ignore_index=True)

# Sortieren, damit Einträge mit `person_username` zuerst kommen
person_df.sort_values(by=['person_name', 'person_username'], ascending=[True, False], inplace=True)

# Markieren von doppelten `person_name`-Datensätzen und Entfernen nicht gewünschter Einträge
person_df = person_df.loc[~(person_df.duplicated(subset=['person_name'], keep='first')) | person_df['person_name'].isna()]
...
person_file_fin = person_file.replace('_kk_pk.csv', '_kk_pk_fin1.csv')
koerperschaft_file_fin = koerperschaft_file.replace('_kk_pk.csv', '_kk_pk_fin1.csv')
