...
CREATE TABLE literaturzeitschrift_ausgabe (
    ...
    verfasser_ke_beitraege VARCHAR(255),
...
CREATE TABLE plattform_internet (
	...
	gruender_betreiber VARCHAR(255),
...
-- CSV-Dateien importieren aus Pfadzu
