-- Die Schritte sind alle einzeln nacheinander auszuführen (nur so wurden sie getestet)

-- Erstellen der Tabelle für Personen
CREATE TABLE person_rolle_objekt (
    objekt_id VARCHAR(255),
    objekt_typ VARCHAR(50),
    person_id VARCHAR(10) REFERENCES person(person_id),
    rolle TEXT,
...
CREATE TABLE koerperschaft_rolle_objekt (
    objekt_id VARCHAR(255),
    objekt_typ VARCHAR(50),
    koerperschaft_id VARCHAR(10) REFERENCES koerperschaft(koerperschaft_id),
    rolle TEXT,
